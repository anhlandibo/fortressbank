...
public enum ErrorCode {
    ...
    /* Account */
    ACCOUNT_NOT_FOUND(404, "Account not found", HttpStatus.NOT_FOUND), ACCOUNT_STATUS_CONFLICT(409, "Invalid account status transition", HttpStatus.CONFLICT), ACCOUNT_CLOSE_NONZERO_BALANCE(409, "Cannot close account with non-zero balance", HttpStatus.CONFLICT), ACCOUNT_INVALID_BALANCE(400, "Invalid balance amount", HttpStatus.BAD_REQUEST), INSUFFICIENT_FUNDS(400, "Insufficient funds", HttpStatus.BAD_REQUEST), FORBIDDEN(403, "You do not have permission to perform this action", HttpStatus.FORBIDDEN), INVALID_OTP(400, "Invalid OTP code", HttpStatus.BAD_REQUEST);
