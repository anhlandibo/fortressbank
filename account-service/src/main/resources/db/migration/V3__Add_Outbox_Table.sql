...
CREATE TABLE IF NOT EXISTS outbox_events (
    ...
    aggregate_type VARCHAR(100) NOT NULL, -- e.g., Account, User
    aggregate_id VARCHAR(100) NOT NULL, -- e.g., account_id, user_id
    event_type VARCHAR(100) NOT NULL, -- e.g., AccountCreated, BalanceUpdated
